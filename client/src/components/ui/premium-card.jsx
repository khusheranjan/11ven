...
const Card = React.forwardRef<HTMLDivElement, React.HTMLAttributes & { hoverable?: boolean }>(
  ({ className, hoverable = false, ...props }, ref) => (
    <div
      ref={ref}
      className={cn(
        "rounded-xl bg-card text-card-foreground shadow-soft transition-smooth",
        hoverable && "hover,
        className,
      )}
      {...props}
