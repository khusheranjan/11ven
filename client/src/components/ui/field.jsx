...
const fieldVariants = cva(
  'group/field flex w-full gap-3 data-[invalid=true]:text-destructive',
  {
    variants,
        ...
        responsive,
          '@md/field-group=field-label]]:flex-auto',
          '@md/field-group=field-content]]:items-start @md/field-group=field-content]]:[&>[role=checkbox],[role=radio]]:mt-px',
        ],
      },
    },
    defaultVariants,
  ...
  return (
    <Label
      ...
      className={cn(
        ...
        'has-data-[state=checked]:bg-primary/5 has-data-[state=checked]:border-primary dark=checked]:bg-primary/10',
        className,
      )}
      {...props}
    />
